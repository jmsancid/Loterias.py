...
def sql_savecomb(combinaciones=None):
    """
    ...
    :param combinaciones:combinaciones a añadir. Es una tupla con 3 o 4 diccionarios según sea euromillones o
     primitiva. Cada diccionario contiene las combinaciones seleccionadas. 5 combinaciones para primitiva y 2
...
def db_update():
    ...
    try:
        con = sql_connection(cte.DBDIR + cte.DBFILE)
        sql_update(con, cte.PRIMITIVA)
        sql_update(con, cte.EUROMILLONES)
    except Error:
